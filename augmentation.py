...
InPath = "raw_data/archive/kaldi-taiwanese-asr/train"
OutPath = "raw_data/archive/kaldi-taiwanese-asr/noisy-train"
...
augment2 = Compose([
    ...
    AddBackgroundNoise(
        sounds_path= os.path.join(root,"audiomentations","background_noises"),
        min_snr_in_db=10,
        max_snr_in_db=30.0,
        p=0.4),
    AddShortNoises(
    sounds_path= os.path.join(root,"audiomentations","short_noises"),
    min_snr_in_db=10,
    max_snr_in_db=30.0,
    ...
    ApplyImpulseResponse(
            ir_path=os.path.join(root,"audiomentations","room_impulse_response"), p=0.4
        )
])
